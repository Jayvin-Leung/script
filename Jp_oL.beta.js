var Jp_oL = (function(e, utils) {
	...
	function renderBox(m, r, _self, _top) {
		...
		function renderBar(parent) {
			...
			function renderLeft(parent) {
				let left = document.createElement("div");
				left.setAttribute("style", "width: 12%;justify-content: left;");
				parent.appendChild(left);
			...
			function renderCenter(parent) {
				...
				center.setAttribute("style", "width: 60%;");
				parent.appendChild(center);

				let search = document.createElement("input");
				search.setAttribute("type", "text");
				search.setAttribute("placeholder", "输入查找内容");
				search.setAttribute("style", "width: 100%;height: 100%;padding: 2px;border: 1px solid #e9edf2;border-radius: 4px;");
