var Jp_oL = (function(e, utils) {
	...
	function init() {
		...
		if (jarea) {
			...
			jarea.id = "jarea";
			jarea.setAttribute("style", "z-index: auto;position: relative;");
		...
		function renderStyle(parent) {
			...
			style.innerHTML += "#jbar > div:first-child > .jbtn {width: 14px;padding: 0 2px;}";
		...
		function renderNav(parent) {
			...
			if (jnav) {
				...
				jnav.id = "jnav";
				jnav.setAttribute("style", "position: absolute;" 
											+ "left: 8px;" 
											+ "bottom: 80px;" 
											+ "padding: 6px;" 
											+ "background: #ffffff;" 
	...
	function renderBox(m, r, _self, _top) {
		...
		if (jbox) {
			...
			jbox.id = "jbox";
			jbox.setAttribute("style", "position: absolute;" 
										+ "left: 8px;" 
		...
		function renderHr(parent) {
			...
			hr.setAttribute("style", "border-color: rgb(0 0 0 / 8%);");
		...
		function renderBar(parent) {
			...
			function renderLeft(parent) {
				...
				function renderChild(parent) {
					...
					child.setAttribute("style", "padding-left: 4px;");
			...
			function renderCenter(parent) {
				...
				search.setAttribute("style", "height: 100%;border: 1px solid #e9edf2;border-radius: 4px;");
		...
		function renderContent(parent, action) {
			...
			function renderMsg(parent, msg) {
				...
				p.innerHTML = msg;
				p.setAttribute("style", "text-align: center;font-size: 20px;color: #999;");
